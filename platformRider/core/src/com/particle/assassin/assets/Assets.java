package com.particle.assassin.assets;
...
public class Assets implements Disposable, AssetErrorListener {
    ...
    public void init() {
        ...
        BitmapFont bebasSmall =
                assetManager.get("bebasSmall.otf", BitmapFont.class);
        BitmapFont bebasBig =
                assetManager.get("bebasBig.otf", BitmapFont.class);
        //this.assetManager = assetManager;
        ...
        fonts = new AssetFonts(bebasSmall, bebasBig);
    ...
    public class AssetFonts {
        ...
        public final BitmapFont bebasSmall;
        public final BitmapFont bebasBig;

        public AssetFonts(BitmapFont bebasSmall, BitmapFont bebasBig) {
            ...
            this.bebasSmall = bebasSmall;
            this.bebasBig = bebasBig;
        }
    }
