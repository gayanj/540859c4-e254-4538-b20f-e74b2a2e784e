...
public class GameScreenWorldRenderer implements WorldRendererInterface {
    ...
    private void renderGuiScore() {
        ...
        /*Assets.instance.fonts.defaultSmall.draw(batch,
                "SCORE",
                x, y);*/
        Assets.instance.fonts.bebasSmall.draw(batch,
                "SCORE",
                x, y);
        /*Assets.instance.fonts.defaultSmall.draw(batch, "" + gameScreenWorldController.getScore(),
                x, y - 50);*/
        Assets.instance.fonts.bebasSmall.draw(batch, "" + gameScreenWorldController.getScore(),
                x, y - 50);
    }
    ...
    private void renderGuiGameOverMessage() {
        ...
        float y = cameraGUI.viewportHeight / 2 + 400;
        BitmapFont fontGameOver = Assets.instance.fonts.bebasBig;
    ...
    private void renderHighScore() {
        ...
        BitmapFont fontHighScore = Assets.instance.fonts.bebasBig;
    ...
    private void renderBackground(){
        gameScreenWorldController.background.render(batch);
    }
    ...
    public void renderKillStreakText() {
        ...
        if (gameScreenWorldController.isRenderKillStreak()) {
            BitmapFont fontKillStreak = Assets.instance.fonts.bebasBig;
